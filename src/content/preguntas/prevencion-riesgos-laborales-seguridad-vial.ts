...
export const preguntas: Pregunta[] = [
  {
    id: "prlsv-01",
    enunciado: "¿Qué principio de la acción preventiva del artículo 15 de la Ley 31/1995 resulta especialmente relevante al actuar en la vía pública junto al tráfico rodado?",
    opciones: [
      "Combatir los riesgos en su origen y anteponer la protección colectiva a la individual, complementadas con equipos de protección individual cuando el riesgo no pueda eliminarse por otros medios",
      "Ninguno, la Ley 31/1995 no resulta de aplicación a la actuación en vía pública",
      "Únicamente el principio de evitar los riesgos, sin ninguna otra consideración",
      "El principio de sustituir siempre la actuación policial por medios exclusivamente automatizados",
    ],
    correcta: 0,
    explicacion:
      "Los principios generales de la acción preventiva del art. 15 de la Ley 31/1995 —evitar los riesgos, combatirlos en su origen y anteponer la protección colectiva a la individual— se proyectan sobre la actuación en vía pública mediante medidas como la señalización, la delimitación del área de actuación y el uso de equipos de protección individual cuando el riesgo derivado del tráfico no pueda eliminarse por otros medios.",
  },
  {
    id: "prlsv-02",
    enunciado: "¿Qué función cumple el chaleco o prenda de alta visibilidad en la actuación policial en vía pública?",
    opciones: [
      "Aumentar la visibilidad del agente frente a los conductores, especialmente en condiciones de baja luminosidad, reduciendo el riesgo de atropello",
      "Ninguna función preventiva, se trata de un elemento exclusivamente identificativo del rango",
      "Sustituir la necesidad de señalizar la vía con conos o balizas",
      "Proteger frente a agresiones físicas directas, como si fuera un chaleco antibalas",
    ],
    correcta: 0,
    explicacion:
      "Las prendas de alta visibilidad (chalecos o similares, con tejidos reflectantes) tienen como función aumentar la visibilidad del agente frente a los conductores que se aproximan, especialmente en condiciones de baja luminosidad o de escasa visibilidad meteorológica, reduciendo así el riesgo de atropello durante la actuación en la vía.",
  },
  {
    id: "prlsv-03",
    enunciado: "¿Qué medida de señalización se recomienda al establecer un control o intervenir en un accidente en carretera?",
    opciones: [
      "Delimitar y señalizar con suficiente antelación el área de actuación (conos, balizas luminosas, señales de peligro), de modo que los conductores dispongan de tiempo suficiente para reducir la velocidad y reaccionar con seguridad",
      "No es necesaria ninguna señalización si el vehículo policial lleva las luces de emergencia encendidas",
      "Basta con la presencia visual del agente, sin ningún elemento adicional de señalización",
      "La señalización solo es obligatoria en autopistas, nunca en carreteras convencionales",
    ],
    correcta: 0,
    explicacion:
      "La buena praxis en materia de prevención de riesgos aconseja delimitar y señalizar con suficiente antelación el área de actuación mediante conos, balizas luminosas u otras señales de peligro, de forma que los conductores que se aproximan dispongan de tiempo y distancia suficientes para percibir la situación, reducir la velocidad y reaccionar con seguridad.",
  },
  {
    id: "prlsv-04",
    enunciado: "¿Por qué se recomienda posicionar el vehículo policial de forma que proteja físicamente al agente durante una actuación en el arcén o en el carril de circulación?",
    opciones: [
      "Porque el propio vehículo puede actuar como barrera física frente a un posible impacto de otro vehículo, reduciendo el riesgo de atropello del agente que actúa a pie de calzada",
      "Únicamente por motivos estéticos o de protocolo, sin relación con la seguridad",
      "Porque está prohibido que el vehículo policial permanezca detenido en el arcén",
      "Porque de ese modo se evita cualquier necesidad de señalización adicional",
    ],
    correcta: 0,
    explicacion:
      "Posicionar el vehículo policial de forma estratégica —habitualmente formando un ángulo que proteja el área de trabajo del agente— permite que el propio vehículo actúe como barrera física frente a un posible impacto de otro vehículo, reduciendo significativamente el riesgo de atropello de quien actúa a pie de calzada.",
  },
  {
    id: "prlsv-05",
    enunciado: "¿Qué riesgos específicos, además del atropello, debe tener en cuenta un agente que actúa junto a una vía de circulación?",
    opciones: [
      "La exposición a condiciones meteorológicas adversas, la inhalación de gases y partículas contaminantes del tráfico, el ruido, y la fatiga o el estrés derivados de una exposición prolongada",
      "Ningún riesgo adicional distinto del propio atropello",
      "Únicamente riesgos derivados del uso de armas de fuego",
      "Solo riesgos de tipo informático o cibernético",
    ],
    correcta: 0,
    explicacion:
      "Además del riesgo de atropello, la actuación prolongada en vía pública expone al agente a otros riesgos, como las condiciones meteorológicas adversas (frío, calor, lluvia), la inhalación de gases y partículas contaminantes procedentes del tráfico, la exposición al ruido, y la fatiga o el estrés psicológico derivados de una exposición prolongada a un entorno de riesgo constante.",
  },
  {
    id: "prlsv-06",
    enunciado: "¿Qué papel desempeña la formación específica en seguridad vial dentro de la prevención de riesgos laborales policiales?",
    opciones: [
      "Permite a los agentes conocer y aplicar correctamente los protocolos de señalización, posicionamiento y actuación segura en la vía pública, reduciendo la probabilidad de accidentes durante el servicio",
      "No tiene ninguna relevancia práctica, ya que estos riesgos son inevitables",
      "Se limita exclusivamente a la conducción de vehículos, sin relación con la actuación a pie de calle",
      "Es responsabilidad exclusiva de cada agente, sin ninguna obligación formativa institucional",
    ],
    correcta: 0,
    explicacion:
      "La formación específica en seguridad vial —protocolos de señalización, técnicas de posicionamiento seguro, gestión de situaciones de riesgo en carretera— es un elemento clave de la prevención de riesgos laborales aplicada a la actividad policial, coherente con el derecho a la formación preventiva reconocido con carácter general en el artículo 19 de la Ley 31/1995 y en su desarrollo específico para el CNP en el Real Decreto 2/2006.",
  },
  {
    id: "prlsv-07",
    enunciado: "¿Qué recomienda la buena praxis respecto de la duración de la exposición de un agente a un punto de riesgo en la vía pública (por ejemplo, un control prolongado)?",
    opciones: [
      "Rotar o relevar periódicamente a los agentes expuestos, cuando sea posible, para limitar el tiempo de exposición individual a los riesgos del tráfico y a la fatiga asociada",
      "Mantener siempre al mismo agente en el mismo punto durante toda la actuación, sin relevos",
      "No existe ninguna recomendación al respecto, la duración es indiferente",
      "Suspender siempre la actuación tras los primeros diez minutos, sin excepción",
    ],
    correcta: 0,
    explicacion:
      "Cuando resulta operativamente posible, la buena praxis preventiva aconseja rotar o relevar periódicamente a los agentes expuestos a un punto de riesgo continuado en la vía pública, con el fin de limitar el tiempo de exposición individual a los riesgos propios del tráfico y a la fatiga acumulada derivada de una atención sostenida en un entorno de peligro constante.",
  },
  {
    id: "prlsv-08",
    enunciado: "¿Qué relación existe entre la prevención de riesgos laborales en seguridad vial y el marco general de la Ley 31/1995 estudiado en otros temas?",
    opciones: [
      "Es una aplicación específica de los principios generales de dicha ley —evaluación de riesgos, planificación preventiva, formación, equipos de protección— al contexto concreto de la actuación policial junto al tráfico rodado",
      "No guarda ninguna relación, se trata de un régimen jurídico completamente autónomo y distinto",
      "Sustituye por completo al régimen general de la Ley 31/1995 para las Fuerzas y Cuerpos de Seguridad",
      "Solo es aplicable a los agentes de tráfico, nunca a otras unidades policiales",
    ],
    correcta: 0,
    explicacion:
